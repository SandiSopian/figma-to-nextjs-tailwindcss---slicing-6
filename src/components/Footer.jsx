...
const Footer = () => {
  ...
  return (
    <div className="container mx-auto text-FontColor2">
      <div>
        <Image src={footerImg} alt="footer" className="mx-auto px-8 py-10" />
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center md:justify-evenly mb-24">
        <div className="flex flex-col justify-center md:justify-between items-center md:items-start py-10 gap-6 md:w-1/2">
          ...
          {/* Social Media */}
          <div>
            <Link href={footerIg}>Instagram</Link>
            <Link href={footerFb}>Facebook</Link>
            <Link href={footerWebsite}>Website</Link>
          </div>

          <p className="w-80 md:w-full md:max-w-md">Stay updated with the lastest trends and exclutsive offers from Bardi. Follow our newsletter</p>
          ...
          <div className="flex justify-between border border-gray-300 rounded-md max-w-sm">
            ...
            <button className="ml-1 px-3 py-1 bg-ButtonColor border">
